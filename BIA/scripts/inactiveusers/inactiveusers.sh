...
#-  Revision 1.3  - Edgar Bowlin - 02-13-2023 - Added global functions library.                   -
#--------------------------------------------------------------------------------------------------
...
PWPATH=/home/oracle/scripts/passwordmgmt
PWOUTPUT=/home/oracle/scripts/passwordmgmt/output
