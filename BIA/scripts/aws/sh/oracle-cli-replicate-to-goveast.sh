...
aws rds create-db-instance-read-replica \
    --db-instance-identifier $SOURCENAME \
    --db-subnet-group-name db-subnet-prod-gp-app-prod-a \
    --kms-key-id arn:aws-us-gov:kms:us-gov-east-1:532813628429:key/58d9374b-1f8f-49b7-87f3-9636b8d18183 \
    --source-db-instance-identifier $SOURCEARN \
