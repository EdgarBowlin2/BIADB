#-----------------------------------------------------------------------------------------
#-  EC2 Snapshot Status V1.4                                                 04-25-2022
#-----------------------------------------------------------------------------------------
#-  Edgar Bowlin
#-----------------------------------------------------------------------------------------
#-  Purpose / Overview
...
#-  1.3   Edgar Bowlin  11-14-2022      Changed paths, added Connor Northrop, and
#-					added new input server instance names for rhel8.
#-  1.4   Edgar Bowlin  02-13-2023      Added new global functions library.
#-----------------------------------------------------------------------------------------
...
input="/home/oracle/scripts/bia-devel/BIA/scripts/dbsnapshot/serverlist"
...
/usr/sbin/sendmail -v "edgar.bowlin@va.gov, patrick.lynn@va.gov connor.northrop" -s "EC2 Snapshot Status" < /home/oracle/scripts/bia-devel/BIA/scripts/dbsnapshot/SnapshotFails.txt
