...
echo "aws cloudformation create-stack --stack-name ${stackname} --template-url https://bip-bpds-prodtest.s3-us-gov-west-1.amazonaws.com/upload/edgarprod.yml"
aws cloudformation create-stack --stack-name ${stackname} --template-url https://bip-bpds-prodtest.s3-us-gov-west-1.amazonaws.com/upload/edgarprod.yml 
...
export conn="(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=edgar-replica.cetxxdbd6our.us-gov-west-1.rds.amazonaws.com)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SID=ORCL)))"
