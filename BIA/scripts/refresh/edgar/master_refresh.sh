...
export basedir=/home/oracle/bia-devel/BIA/scripts/refresh/edgar
export email=do_not_reply@va.gov
export refreshdb=edgar-replica
export stackname=edgar-stack
export instancename=edgar-replica
export refreshlog=$basedir/logs/refresh.log
...
export connectstr="(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=edgar-replica.cetxxdbd6our.us-gov-west-1.rds.amazonaws.com)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SID=ORCL)))"
...
/usr/sbin/sendmail -v "edgar.bowlin@va.gov, patrick.lynn@va.gov" -s "Database Refresh for patrick-replica Complete" < /home/oracle/bia-devel/BIA/scripts/refresh/edgar/logs/refresh.log
